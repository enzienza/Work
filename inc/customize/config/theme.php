...
// fonction qui vérifie si le 'mywork_supports' exixte déjà avant de l'initialiser
if(!function_exists('mywork_supports')){
    function mywork_supports(){
        ...
        load_theme_textdomain( 'MyWork', get_template_directory() . '/languages' );
    }
}
add_action('after_setup_theme','mywork_supports' );
 ...
 */
if(!function_exists('mywork_title_separator')){
    function mywork_title_separator(){
        return '|';
    }
}
add_filter( 'document_title_separator', 'mywork_title_separator');

/** ==============================================================================================
 * 4 - Hiden Version WP
 */
//	Securité : Cacher la verion du WordPress utilisé
function mywork_remove_version_strings( $src ) {
    global $wp_version;
...
add_filter( 'script_loader_src', 'mywork_remove_version_strings' );
add_filter( 'style_loader_src', 'mywork_remove_version_strings' );

// Hide WP version strings from generator meta tag
function mywork_remove_version() {
    return '';
}

add_filter('the_generator', 'mywork_remove_version');