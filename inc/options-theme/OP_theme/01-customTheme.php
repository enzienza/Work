        ...
        <table class="widefat importers striped">
            ...
            <tr class="importer-item">
                <td class="import-system">
                    ...
                    <span class="importer-action">
                      <a href="?page=mycustome_core" class="install-now"><?php _e("Gérer la section", "MyWork"); ?></a>
                    </span>
                </td>
                <td class="desc">
            ...
            <tr class="importer-item">
                <td class="import-system">
                    ...
                    <span class="importer-action">
                      <a href="?page=mycustome_home" class="install-now"><?php _e("Gérer la section", "MyWork"); ?></a>
                    </span>
                </td>
                <td class="desc">
                    <span class="importer-desc">
            ...
            <tr class="importer-item">
                <td class="import-system">
                    ...
                    <span class="importer-action">
                      <a href="?page=mycustome_contact" class="install-now"><?php _e("Gérer la section", "MyWork"); ?></a>
                    </span>
                </td>
                <td class="desc">
                    <span class="importer-desc">
            ...
            <tr class="importer-item">
                <td class="import-system">
                    ...
                    <span class="importer-action">
                      <a href="?page=mycustome_errorpage" class="install-now"><?php _e("Gérer la section", "MyWork"); ?></a>
                    </span>
                </td>
                <td class="desc">
                    <span class="importer-desc">
